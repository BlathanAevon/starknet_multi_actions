MINT_ID_ABI = [
    ...
    {
        "data": [
            {"name": "previousAdmin", "type": "felt"},
            {"name": "newAdmin", "type": "felt"},
        ],
        "keys": [],
        "name": "AdminChanged",
        "type": "event",
    ...
    {
        "data": [
            {"name": "inft_contract", "type": "felt"},
            {"name": "inft_id", "type": "felt"},
            {"name": "starknet_id", "type": "felt"},
        ],
        "keys": [],
    ...
    },
    {
        ...
        "inputs": [
            ...
            {"name": "uri_base_len", "type": "felt"},
            {"name": "uri_base", "type": "felt*"},
        ],
        "outputs": [],
    },
    {
    ...
    },
    {
        "name": "ownerOf",
        "type": "function",
        "inputs": [{"name": "starknet_id", "type": "Uint256"}],
    ...
    },
    {
        "name": "owner_of",
        "type": "function",
        "inputs": [{"name": "starknet_id", "type": "felt"}],
        "outputs": [{"name": "owner", "type": "felt"}],
        "stateMutability": "view",
    },
    {
    ...
    },
    {
        ...
        "outputs": [{"name": "is_approved", "type": "felt"}],
        "stateMutability": "view",
    },
    {
        "name": "tokenURI",
    ...
    },
    {
        ...
        "outputs": [{"name": "starknet_id", "type": "felt"}],
        "stateMutability": "view",
    },
    {
        "name": "approve",
